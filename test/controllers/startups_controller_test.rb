...
class StartupsControllerTest < ActionController::TestCase
  ...
  test "should create startup" do
    assert_difference('Startup.count') do
      post :create, startup: { city: @startup.city, description: @startup.description, logo: @startup.logo, name: @startup.name, tagline: @startup.tagline }
    end
  ...
  test "should update startup" do
    patch :update, id: @startup, startup: { city: @startup.city, description: @startup.description, logo: @startup.logo, name: @startup.name, tagline: @startup.tagline }
    assert_redirected_to startup_path(assigns(:startup))
  end
