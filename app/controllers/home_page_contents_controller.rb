  ...
  def create
    ...
    respond_to do |format|
      if @home_page_content.save
        format.html { redirect_to dashboard_index_path, notice: 'Home page content was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @home_page_content.update(home_page_content_params)
        format.html { redirect_to dashboard_index_path, notice: 'Home page content was successfully updated.' }
