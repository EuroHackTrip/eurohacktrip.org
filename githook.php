  ...
  */
  public function execute()
  {
      try
      {
		...
		// apache own
		// exec('sudo chown -R www-data:www-data .', $output);
		// $this->log('Made repo owner www-data:www-data. Running as '.shell_exec('whoami').implode(" ", $output));
    ...
    // reloading server
    exec('service apache2 reload', $output);
